...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕ Ayaan▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈    |    Ayaan ▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mMahummadAyaan.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
...
\033[1;91m☞ Auther     : Mahummad Ayaan
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + 2 + ' Update Mahummad Ayaan Tool')
	print (S + '[' + P + '☞3' + S + ']' + 3 + ' 03213915156')
	print (S + '[' + Y + '☞4' + S + ']' + 4 + ' Log Out')
	print (S + '[' + Y + '☞0' + S + ']' + 5 + ' Exit')
	print
	print (S + 50*'-')
	print
	mb()
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Mahummad Ayaan')
	    ...
	    psb('WellCome To Mahummad Ayaan')
	    psb('Congratulations Mahummad Ayaab Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Paid✓')
	    psb('🔓Password ☆ Tool Unlock✓')
	    psb('Subscrib My Youtube Channel https://www.youtube.com/@mahummadayaantricks9498✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Mahummad-Ayaan')
	elif bm =='3':
	    os.system('xdg-open 03213915156')
	    menu()
	elif bm =='4':
